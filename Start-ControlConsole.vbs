...
If pythonw = "" Then
  MsgBox "Python was not found. Install Python 3.11 or newer, then run Start-ControlConsole again.", vbExclamation, "Codex Control Console"
  WScript.Quit 1
End If
...
If Err.Number <> 0 Then
  MsgBox "Codex Control Console could not start. Check that Python and the app files are still in this folder.", vbExclamation, "Codex Control Console"
End If
