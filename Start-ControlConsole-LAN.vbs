...
If pythonw = "" Then
  MsgBox "Python was not found. Install Python 3.11 or newer, then run Start-ControlConsole-LAN again.", vbExclamation, "Codex Console"
  WScript.Quit 1
End If
...
If Err.Number <> 0 Then
  MsgBox "Codex Console could not start in LAN mode. Check that Python and the app files are still in this folder.", vbExclamation, "Codex Console"
End If
